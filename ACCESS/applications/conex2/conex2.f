...
C    
C $Id: conex2.f,v 1.2 2009/03/25 14:35:16 gdsjaar Exp $
C************************************************************************
      PROGRAM CONEX2
C************************************************************************
...
C     rfile - name of results file
      character*(mxlnln) mfile, nfile, rfile
