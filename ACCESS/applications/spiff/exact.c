...
#ifndef lint
static char rcsid[] =
    "$Header: /usr/sharelan/cvs/SEACAS/prepost/spiff/exact.c,v 1.2 2004/10/29 14:00:40 gdsjaar Exp $";
#endif
...
*/
E_edit Q_do_exact(int size1, int size2, int max_d, int comflags)
{
    int i = 0;
    int diffcnt = 0;
	...
	(void) sprintf(Z_err_buf,
		       "unequal number of tokens, %d and %d respectively\n",
		       size1, size2);
