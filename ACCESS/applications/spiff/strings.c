...
#ifndef lint
static char rcsid[] =
    "$Header: /usr/sharelan/cvs/SEACAS/prepost/spiff/strings.c,v 1.2 2004/10/29 14:00:41 gdsjaar Exp $";
#endif
...
*/
void S_wordcpy(char *to, char *from)
{
...
*/
void S_savestr(char **to, char *from)
{
...
*/
void S_savenstr(char **to, char *from, int cnt)
{
    S_allocstr(to, cnt);
...
*/
void S_allocstr(char **to, int size)
{
