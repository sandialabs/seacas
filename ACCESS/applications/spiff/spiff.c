...
#ifndef lint
static char rcsid[] =
    "$Header: /usr/sharelan/cvs/SEACAS/prepost/spiff/spiff.c,v 1.2 2004/10/29 14:00:41 gdsjaar Exp $";
#endif
...
static void _Y_doargs(int argc, char **argv, char **file1, char **file2,
		      int *max_d);
...
*/
static void _Y_cmdlines(char *from)
{
    char buf[Z_LINELEN];
    char *to;
    while ('\0' != *from) {
