...
extern T_tol T_gettol(int index);
extern void T_clear_tols(void);
extern void T_initdefault(void);
extern void T_setdef(char *str);
extern void T_tolline(char *str);
extern T_tol T_picktol(T_tol p1, T_tol p2);
...
extern void _T_addtol(T_tol * listptr, int type, char *str);
extern void _T_appendtols(T_tol * to, T_tol from);
