...
#ifndef lint
static char rcsid[] =
    "$Header: /usr/sharelan/cvs/SEACAS/prepost/spiff/command.c,v 1.3 2004/10/29 14:00:40 gdsjaar Exp $";
#endif
...
*/
void C_clear_cmd(void)
{
    _C_cmdword[0] = '\0';
    return;
}

int C_is_cmd(char *input_line)
{
    char *ptr;
    /*
