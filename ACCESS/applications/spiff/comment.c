...
#ifndef lint
static char rcsid[] =
    "$Header: /usr/sharelan/cvs/SEACAS/prepost/spiff/comment.c,v 1.2 2004/10/29 14:00:40 gdsjaar Exp $";
#endif
...
*/
void W_addcom(char *str, int nestflag)
{
    /*
...
static void _W_copybol(W_bol to, W_bol from)
{
...
static void _W_copylit(W_lit to, W_lit from)
{
    (void) strcpy(to->begin, from->begin);
    (void) strcpy(to->end, from->end);
    (void) strcpy(to->escape, from->escape);
...
static void _W_copycom(W_com to, W_com from)
{
    (void) strcpy(to->begin, from->begin);
    (void) strcpy(to->end, from->end);
    (void) strcpy(to->escape, from->escape);
