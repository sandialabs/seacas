...
C $Id: sndtim.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: sndtim.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:13:28  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:57:55  gdsjaar
c Added RCS Id and Log to all files
c
C=======================================================================
      SUBROUTINE SNDTIM (OPTION, NSTEPS, NSTEPW, TIMES, WHOTIM, *)
C=======================================================================

C   --*** SNDTIM *** (BLOT) Send database time step times
C   --   Written by Amy Gilkey - revised 05/04/88
C   --
C   --SNDTIM sends all time steps times as a message.  It also sends the
C   --number of time steps.
C   --
C   --Parameters:
C   --   OPTION - IN - '*' to send all, else message options:
C   --      'H' to send number of times
C   --      'T' to send times
C   --      'W' to send whole times indicator
...
C   --      (if OPTION)
C   --   TIMES - OUT - the database time steps (if OPTION)
C   --   WHOTIM - OUT - the whole time indicator (if OPTION);
