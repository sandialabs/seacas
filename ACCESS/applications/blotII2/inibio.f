...
C $Id: inibio.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: inibio.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:03:39  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.3  1991/04/11  13:54:30  gdsjaar
c Added () to function definitions
c
c Revision 1.2  1990/12/14  08:52:32  gdsjaar
c Added RCS Id and Log to all files
c
      function inibio()

      write (*, 10000)
10000  format (1x, '% ', 'INIBIO')
