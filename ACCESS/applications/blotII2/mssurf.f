...
C $Id: mssurf.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: mssurf.f,v $
...
C assertion.
C
C Revision 1.3  2004/10/18 16:30:00  gdsjaar
C Add capability to handle tet elements.
C
C There are still a few minor problems, but the display is substantially correct.
C
C Revision 1.2  1999/11/12 16:50:06  gdsjaar
C Incorrect index passed to mdlong. It was overwritten in later mdlong
C call for another array and then the 'correct' index (now pointing to
C deleted memory) was passed into subroutine.
C
C Revision 1.1  1994/04/07 20:06:01  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:54:10  gdsjaar
