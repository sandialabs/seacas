...
C $Id: hidedg.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: hidedg.f,v $
...
C
C Revision 1.2  1994/04/08 13:25:55  gdsjaar
C Removed hash mark from comments.
C
c Revision 1.1  1994/04/07  20:03:10  gdsjaar
c Initial checkin of ACCESS/graphics/blotII2
c
c Revision 1.2  1990/12/14  08:52:15  gdsjaar
c Added RCS Id and Log to all files
c
C=======================================================================
      SUBROUTINE HIDEDG (HIDEF, HIDENP, LENF, NLNKE, NLNKF, LINKF,
     &   NOTSEL, IELBST, IEDSET, NEDGES, NREF, LREF, ISBACK, NAMELB)
C=======================================================================
...
C                  --Search for line in existing lines
                     ...
                     DO 150 IL = MIN (LREFN1, LREFN2, NOLD), 1, -1
                        IF (IEDSET(1,IL) .EQ. NMIN) THEN
                           IF (IEDSET(2,IL) .EQ. NMAX) GOTO 160
                        END IF
  150                CONTINUE
  160                CONTINUE
...
C                  --Search for line in existing lines
                     ...
                     DO 260 IL = MIN (LREFN1, LREFN2, NOLD), 1, -1
                        IF (IEDSET(1,IL) .EQ. NMIN) THEN
                           IF (IEDSET(2,IL) .EQ. NMAX) GOTO 270
                        END IF
  260                CONTINUE
  270                CONTINUE
