...
C $Id: putlr.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: putlr.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:08:27  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:55:36  gdsjaar
c Added RCS Id and Log to all files
c
      integer function putlr (tag, logary, lenin)
      character*(*) tag
      logical logary(*)

      write (*, 10000) tag, lenin, logary(1)
10000  format (1x, '% ', 'PUT logical ', a, ', length =', i5,
     &   ', value =', l1)
