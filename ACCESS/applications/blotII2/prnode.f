...
C $Id: prnode.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: prnode.f,v $
...
C   --   VARNP - IN - the selected nodal variables for the time step
      ...
      IF (NOUT .GT. 0) THEN
         WRITE (NOUT, 10010) (NAMENV(LISNV(I))(:14), I=1,LISNV(0))
      ELSE
         WRITE (*, 10010) (NAMENV(LISNV(I))(:14), I=1,LISNV(0))
      END IF
