...
C $Id: fnddis.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: fnddis.f,v $
...
C assertion.
C
C Revision 1.2  1996/01/04 22:07:17  caforsy
C Added comments describing the convention used for naming displacement variables
C
C Revision 1.1  1994/04/07 20:01:05  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:50:43  gdsjaar
