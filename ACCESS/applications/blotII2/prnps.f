...
C $Id: prnps.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: prnps.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:07:52  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:55:16  gdsjaar
...
10030  FORMAT (1X, 'Set', I5, 1X, A, ':',
     &   I6, ' nodes', 1X, A)
10040  FORMAT ((1X, 12I6))
