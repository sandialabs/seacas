...
C $Id: getir.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: getir.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:01:43  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:51:09  gdsjaar
c Added RCS Id and Log to all files
c
      integer function getir (tag, intary, lenin, lenout)
      character*(*) tag
      integer intary(*)

      if (tag .eq. ' ') tag = ' '
      write (*, 10000) tag, lenin
10000  format (1x, '% ', 'GET integer ', a, ', length =', i5, i5)
      lenout = lenin
      do 100 i = 1, lenout
         intary(i) = -999
  100 continue
