...
C $Id: dtshow.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: dtshow.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:00:01  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:49:41  gdsjaar
...
C   --   Uses CINTOK, NCNTR, NOCMIN, NOCMAX, LABINC, MAXMIN, MAXMAX of /CNTR/
      ...
      CHARACTER CH
      CHARACTER*(MXSTLN) NAM(4)
      CHARACTER*20 RSTR(9)
      REAL RNUM(9)
      CHARACTER*(MXSTLN) TNAME(5)
