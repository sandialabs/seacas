...
C $Id: tplabn.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: tplabn.f,v $
...
C assertion.
C
C Revision 1.3  1999/03/09 19:41:43  gdsjaar
C Fixed missing parameter definition of MSHBOR in blotII2.f
C
C Cleaned up parameters and common blocks in other routines.
C
C Revision 1.2  1996/01/05 22:32:05  caforsy
C Fixed problem when using tplot and dumping an xmgr file.  Removed
C static heap for cray platform.
C
C Revision 1.1  1994/04/07 20:16:39  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:59:04  gdsjaar
