...
C $Id: dtmain.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C=======================================================================
...
C            --Set color in case text is requested
               ...
               CALL GRPEND (.TRUE., .TRUE., NPLOT1, NPTIMX, *120, *160)
            END IF
...
C         --Set color in case text is requested
            ...
            CALL GRPEND (.TRUE., .TRUE., NPLOT1, I, *100, *160)
         END IF
  150 CONTINUE
