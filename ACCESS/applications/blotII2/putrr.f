...
C $Id: putrr.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: putrr.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:08:31  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:55:38  gdsjaar
c Added RCS Id and Log to all files
c
      integer function putrr (tag, reaary, lenin)
      character*(*) tag
      real reaary(*)

      write (*, 10000) tag, lenin, reaary(1)
10000  format (1x, '% ', 'PUT real ', a, ', length =', i5,
     &   ', value =', f8.3)
