...
C $Id: cmdzm.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: cmdzm.f,v $
...
C assertion.
C
C Revision 1.3  2009/01/28 21:32:34  gdsjaar
C Revert a previous fix to zoom node id radius which wasn't working correctly.  I don't remember the original problem, so can't do a better fix for it...
C
C Revision 1.2  2007/06/25 17:59:46  gdsjaar
C Fixed the "zoom node {id} {radius} command to work with nodes which
C are not visible in the current view. Command is not documented
C anywhere, but some users are trying to use it and it fails if the node
C is not visible in curent rotation/view.
C
C Revision 1.1  1994/04/07 19:56:39  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:48:41  gdsjaar
