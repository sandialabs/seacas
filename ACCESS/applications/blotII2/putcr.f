...
C $Id: putcr.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: putcr.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:08:19  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:55:32  gdsjaar
c Added RCS Id and Log to all files
c
      integer function putcr (tag, strary, lenin)
      character*(*) tag
      character*1 strary(*)

      write (*, 10000) tag, lenin, strary(1)
10000  format (1x, '% ', 'PUT character ', a, ', length =', i5,
     &   ', value =', 1x, a)
