...
C $Id: sndxyz.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: sndxyz.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:13:36  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:57:59  gdsjaar
c Added RCS Id and Log to all files
c
C=======================================================================
      SUBROUTINE SNDXYZ (OPTION, NDIM, NUMNP, XN, YN, ZN, *)
C=======================================================================

C   --*** RCVXYZ *** (BLOT) Send database coordinates
C   --   Written by Amy Gilkey - revised 05/04/88
C   --
C   --RCVXYZ sends the coordinate array as a message.
C   --
C   --Parameters:
