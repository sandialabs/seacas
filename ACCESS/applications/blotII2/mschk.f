...
C $Id: mschk.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: mschk.f,v $
...
C at this time.
C
C Revision 1.1  1994/04/07 20:05:16  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:53:39  gdsjaar
c Added RCS Id and Log to all files
c
C=======================================================================
      SUBROUTINE MSCHK (PRTOK, OKAY)
C=======================================================================

C   --*** MSCHK *** (MESH) Check that MESH is a valid program to run
C   --   Written by Amy Gilkey - revised 10/23/87
C   --
C   --MSCHK checks that MESH is a valid program.  This is true if
...
C   --Write greeting message
  ...
  100 CONTINUE
      OKAY = .FALSE.
      RETURN
10000  FORMAT (' MESH - a deformed mesh plot program')
      END
