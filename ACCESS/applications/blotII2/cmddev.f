...
C $Id: cmddev.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: cmddev.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 19:56:03  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.6  1993/09/15  20:43:50  gdsjaar
c Added shading (hidden 5) option to blot.  Simple illumination model.
c
c Revision 1.5  1993/08/24  16:53:22  gdsjaar
c Fixed if/else/endif problem in previous commit
c
c Revision 1.4  1993/08/24  16:47:55  gdsjaar
c Added user specified colormap option--specify RGB components that are
c multiplied by the grayscale colormap.  Upped version number.
c
c Revision 1.3  1993/08/16  19:42:40  gdsjaar
c Added new spectrum options: gray, rainbow, hot, terrain, zebra
c
c Revision 1.2  1990/12/14  08:48:19  gdsjaar
