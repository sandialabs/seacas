...
C $Id: getvar.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: getvar.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:01:52  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:51:15  gdsjaar
...
C   --It is connected to unit 90.
      ...
      if (proces .ne. 'MASTER') then
         ...
         CALL REQVAR ('VARIABLE', INSTEP, 1, IVAR, *100)
         IF (INSTEP .GE. 1) THEN
            CALL RCVVAR ('VARIABLE', LENVAR, VAR, *100)
         END IF
      end if
