...
C $Id: sndvar.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: sndvar.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:13:32  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:57:57  gdsjaar
c Added RCS Id and Log to all files
c
C=======================================================================
      SUBROUTINE SNDVAR (OPTION, LENVAR, VAR, *)
C=======================================================================

C   --*** SNDVAR *** (BLOT) Send variable values
C   --   Written by Amy Gilkey - revised 05/04/88
C   --
C   --SNDVAR sends the variable values as a message.
C   --
C   --Parameters:
