...
C $Id: mscomd.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C=======================================================================
...
C   --   Sets NEWCUT, ISCUT, CUTPT, CUTNRM of /CUTOPT/
      ...
      include 'light.blk'
      include 'dualpr.blk'
C     common /dualpr/ proces
C     character*8 proces
      include 'debug.blk'
...
C     character*8 cdebug
      ...
      LOGICAL MSHTYP
      CHARACTER*(*) INLINE(*)
      CHARACTER*(MXSTLN) INVERB
      INTEGER     INTYP(*)
      CHARACTER*(MXSTLN) CFIELD(*)
      INTEGER     IFIELD(*)
      REAL        RFIELD(*)
      ...
      CHARACTER*(MXSTLN) VERB, VERB2
      CHARACTER*(MXSTLN) SAVERB
