...
C $Id: matfac.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: matfac.f,v $
...
C assertion.
C
C Revision 1.2  1997/05/19 21:15:42  gdsjaar
C Better diagnostic message replacing the old 'ERROR - MATFAC'. New
C message gives element number and the nodal connectivity of the face
C where the possible problem was found
C
C Revision 1.1  1994/04/07 20:05:02  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:53:27  gdsjaar
c Added RCS Id and Log to all files
c
C=======================================================================
      INTEGER FUNCTION MATFAC (LINKF1, MAXNPF, NPFS, iel, IERR)
C=======================================================================
...
C               --Diagonal matches so check other nodes
  ...
  110             CONTINUE
                  ...
                  INF4 = LINKF1(4)
                  DO 120 I4 = 1, NPFS(0,INF4)
                     IF (IOLDF .EQ. NPFS(I4,INF4)) GOTO 130
  120             CONTINUE
                  WRITE (*, 10000) IEL, LINKF1
                  IERR = 1
                  GOTO 140
...
C               --nodal references to face
                  ...
                  NPFS(0,INF2) = L - 1
                  L = NPFS(0,INF4)
                  IF (L .GT. I4) NPFS(I4,INF4) = NPFS(L,INF4)
                  NPFS(0,INF4) = L - 1
