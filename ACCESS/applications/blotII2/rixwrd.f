...
C $Id: rixwrd.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: rixwrd.f,v $
...
C assertion.
C
C Revision 1.2  1994/06/13 13:47:39  gdsjaar
C Fixed another character length problem.
C
c Revision 1.1  1994/04/07  20:10:04  gdsjaar
c Initial checkin of ACCESS/graphics/blotII2
c
c Revision 1.2  1990/12/14  08:56:29  gdsjaar
