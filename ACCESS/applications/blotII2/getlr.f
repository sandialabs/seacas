...
C $Id: getlr.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
C $Log: getlr.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:01:46  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:51:11  gdsjaar
c Added RCS Id and Log to all files
c
      integer function getlr (tag, logary, lenin, lenout)
      character*(*) tag
      logical logary(*)

      if (tag .eq. ' ') tag = ' '
      write (*, 10000) tag, lenin
10000  format (1x, '% ', 'GET logical ', a, ', length =', i5, i5)
      lenout = lenin
      do 100 i = 1, lenout
         logary(i) = .false.
  100 continue
