...
C $Id: prelem.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: prelem.f,v $
...
C   --   VAREL - IN - the selected element variables for the time step
      ...
      IF (NOUT .GT. 0) THEN
         WRITE (NOUT, 10010) (NAMEEV(LISEV(I))(:14), I=1,LISEV(0))
      ELSE
         WRITE (*, 10010) (NAMEEV(LISEV(I))(:14), I=1,LISEV(0))
      END IF
