...
C=======================================================================
     ...
     &                   A, IA, KIEVOK, C,
     &                   KNAMES, EXODUS, IDELB, ISHEX, KHEXID, *)
C=======================================================================
C$Id: dbinam.f,v 1.1 2009/03/25 04:47:53 gdsjaar Exp $
...
C      --Get the name indices
     ...
     *    MXSTLN*(NVARHI+NVARGL+NVARNP+NVAREL+NVARNS+NVARSS))
...
C      --Read and pack variable names
     ...
     &                C(KNAMES+MXSTLN*(IXGV-1)), 
     &                C(KNAMES+MXSTLN*(IXNV-1)), 
     &                C(KNAMES+MXSTLN*(IXEV-1)),
     &                C(KNAMES+MXSTLN*(IXNS-1)),
     &                C(KNAMES+MXSTLN*(IXSS-1)))
      END IF
...
C   --Read the element block variable truth table
  ...
  220 CONTINUE
     ...
     &                   namgv, namnv, namev, namns, namss)
      
      include 'params.blk'
      character*(mxstln) namgv(*), namnv(*), namev(*), namns(*),
     *  namss(*)
