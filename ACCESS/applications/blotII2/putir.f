...
C $Id: putir.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: putir.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:08:23  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:55:33  gdsjaar
c Added RCS Id and Log to all files
c
      integer function putir (tag, intary, lenin)
      character*(*) tag
      integer intary(*)

      write (*, 10000) tag, lenin, intary(1)
10000  format (1x, '% ', 'PUT integer ', a, ', length =', i5,
     &   ', value =', i8)
