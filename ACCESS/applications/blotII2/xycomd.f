...
C $Id: xycomd.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: xycomd.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:17:56  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.3  1994/01/14  19:47:45  gdsjaar
c Added capability to write both grafaid and xmgr neutral files.
c
c Revision 1.2  1990/12/14  08:59:37  gdsjaar
