...
C $Id: reqopt.f,v 1.1 2009/03/25 04:47:54 gdsjaar Exp $
C $Log: reqopt.f,v $
...
C assertion.
C
C Revision 1.1  1994/04/07 20:09:48  gdsjaar
C Initial checkin of ACCESS/graphics/blotII2
C
c Revision 1.2  1990/12/14  08:56:20  gdsjaar
c Added RCS Id and Log to all files
c
C=======================================================================
      SUBROUTINE REQOPT (OPTION, *)
C=======================================================================

C   --*** REQOPT *** (BLOT) Request information
C   --   Written by Amy Gilkey - revised 05/04/88
C   --
C   --REQOPT sends as a message requesting information.
C   --
C   --Parameters:
