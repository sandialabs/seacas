...
C=======================================================================
C$Id: dbpini.f,v 1.1 1994/01/24 23:00:53 vryarbe Exp $
C$Log: dbpini.f,v $
CRevision 1.1  1994/01/24 23:00:53  vryarbe
CInitial revision
C
c Revision 1.1.1.1  1990/08/14  16:13:48  gdsjaar
c Testing
c
...
10000     FORMAT (
     &      /, 1X, 'Number of coordinates per node       =', I6
     &      /, 1X, 'Number of nodes                      =', I6
     &      /, 1X, 'Number of elements                   =', I6
     &      /, 1X, 'Number of element blocks             =', I6
     &      )
      END IF
     ...
     &         NUMNPS
         END IF
10010     FORMAT (
     &      /, 1X, 'Number of node sets                  =', I6, :
     &      /, 1X, '   Length of node list               =', I6
     &      )
         IF (NUMESS .GT. 0) THEN
     ...
     &         NUMESS
         END IF
10020     FORMAT
     &      (  1X, 'Number of side sets                  =', I6, :
     &      /, 1X, '   Length of element list            =', I6
     &      /, 1X, '   Length of node list               =', I6
     &      )
      END IF
...
10030     FORMAT (
     &      /, 1X, 'Number of history variables          =', I6
     &      /, 1X, 'Number of global variables           =', I6
     &      /, 1X, 'Number of variables at each node     =', I6
     &      /, 1X, 'Number of variables at each element  =', I6
     &      )
      END IF
