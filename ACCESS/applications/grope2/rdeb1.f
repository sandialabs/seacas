...
C=======================================================================
     ...
     &   LINK, ATRIB, ISEOF, nlnkdm, nelbdm, natrdm)
C=======================================================================
...
C   --upon entry; upon exit at end of element block misc. information.
      ...
      INTEGER LINK(nlnkdm, nelbdm)
      REAL ATRIB(natrdm, nelbdm)

      CHARACTER*80 ERRMSG

      CALL INIINT (NUMLNK*NUMELB, 0, LINK)
      CALL INIREA (NUMATR*NUMELB, 0.0, ATRIB)
