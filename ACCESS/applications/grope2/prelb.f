...
C   --   Written by Amy Gilkey - revised 04/15/88
C   --
...
10010  FORMAT ('(', I10, '..', I10, ')')
     ...
     $                NAMELB(IELB)(:LNAM)
              ELSE
                WRITE (*, 10040) EBNAME(IELB)(:LNM), NAMELB(IELB)(:LNAM)
              END IF
            END IF
  ...
  100          CONTINUE
     ...
     *            MAPN, DOMAPN, MAPE, DOMAPE)
         ...
         NUME = LENE(IELB) - LENE(IELB-1)
         IF (DOCONN) ISLNK = ISLNK + NUME * NUMLNK(IELB)
