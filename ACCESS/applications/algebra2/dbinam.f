...
C=======================================================================
C$Id: dbinam.f,v 1.1 2008/10/31 05:04:00 gdsjaar Exp $
C$Log: dbinam.f,v $
...
C
CRevision 1.9  2008/03/14 13:45:26  gdsjaar
CAdded copyright information to top of all files.
C
CALGEBRA2 is now open-sourced under BSD license
C
CRevision 1.8  1998/03/14 00:05:25  rwstotz
Cdbinam.f converts variable names to uppercase now
C
CRevision 1.7  1997/09/08 17:18:42  gdsjaar
...
C
CRevision 1.6  1997/09/08 15:49:38  gdsjaar
CRemoved unused variable
C
CRevision 1.5  1996/02/12 21:28:40  caforsy
CRemoved redundant checks for ExodusII API calls
C
CRevision 1.4  1995/12/10 15:46:45  caforsy
CIntegrated call to rpterr and mdcomp/mccomp calls
C
CRevision 1.3  1995/10/03 21:36:07  mksmith
CRemoving old algII files
CReplacing modified algII files
C
...
C     NAMEV  - OUT - Returned character array with element variable names
      ...
      character*(mxstln) namgv(*), namnv(*), namev(*)
