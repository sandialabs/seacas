...
C=======================================================================
     ...
     &   NERR)
C=======================================================================
C $Id: chksyn.f,v 1.1 2008/10/31 05:04:00 gdsjaar Exp $
C $Log: chksyn.f,v $
...
C
C Revision 1.9  2008/03/14 13:45:25  gdsjaar
C Added copyright information to top of all files.
C
C ALGEBRA2 is now open-sourced under BSD license
C
C Revision 1.8  2004/03/01 17:24:37  gdsjaar
C Fixed subscripting error on the unode function. It was stored in same place as uglob function which caused problems
C
C Revision 1.7  1997/09/08 17:18:39  gdsjaar
...
C
C Revision 1.6  1996/02/06 00:37:56  caforsy
C Bug fix for previous change.  Used nparam instead of nparm.
C
C Revision 1.5  1996/02/05 21:57:35  caforsy
...
C         --specifier and time specifier
     ...
     &               // ' has an invalid time specifier')
            ...
            IF (ENT20(MXSTLN+1:) .NE. ' ')
     &         CALL PRTERR ('CMDSPEC',
     &         'WARNING - ' // ENT20(:LENSTR(ENT20))
     &         // ' is truncated to "' // ENT20(1:MXSTLN) // '"')
