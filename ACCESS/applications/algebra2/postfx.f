...
C=======================================================================
     ...
     &   NERR)
C=======================================================================
C $Id: postfx.f,v 1.1 2008/10/31 05:04:00 gdsjaar Exp $
C $Log: postfx.f,v $
...
C
C Revision 1.4  1997/09/08 17:18:49  gdsjaar
...
C   --   NERR - IN/OUT - the number of errors in the equation, may be set
      ...
      CHARACTER*(mxstln) STKNAM(MAXENT)
