...
C=======================================================================
C $Id: aparse.f,v 1.1 2008/10/31 05:04:00 gdsjaar Exp $
C $Log: aparse.f,v $
...
C
C Revision 1.4  2003/08/11 14:42:26  gdsjaar
C Parser was not recognizing "." as a valid character in a variable
C name.  Sierra restart files use this character.
C
C Revision 1.3  1995/10/03 21:35:56  mksmith
C Removing old algII files
C Replacing modified algII files
C
C Revision 1.2  1993/08/02 14:20:35  gdsjaar
C Split out common blocks into separare files. Miscellaneous bug fixes
C on several files.  First public release version.
C
c Revision 1.1  1993/07/30  21:41:44  gdsjaar
c Initial checkin of ACCESS/translate/algII
c
c Revision 1.2  1992/04/01  22:26:32  gdsjaar
c Fixed so _ valid character in variable name (fjmello)
c
c Revision 1.1.1.1  1990/11/09  16:23:26  gdsjaar
c Algebra - Unix Version
c
c Revision 1.1  90/11/09  16:23:25  gdsjaar
c Initial revision
c 
