...
C=======================================================================
     ...
     *   NAMELB, IDELB, NEWNOD, NODIX, LNSCR, ATRSCR)
C=======================================================================
C $Id: wconat.f,v 1.1 2008/10/31 05:04:01 gdsjaar Exp $
C $Log: wconat.f,v $
...
C
C Revision 1.3  1996/02/12 21:28:50  caforsy
C Removed redundant checks for ExodusII API calls
C
C Revision 1.2  1995/12/10 15:46:55  caforsy
C Integrated call to rpterr and mdcomp/mccomp calls
C
C Revision 1.1  1995/10/03 21:43:43  mksmith
...
C   --   NAMELB   - IN - the element block type
