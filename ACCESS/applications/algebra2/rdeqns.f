...
C    
C=======================================================================
      SUBROUTINE RDEQNS (A, C, NAMECO, NAMELB, NAMES, QAREC, INFREC,
     &  TIMES, IPTIMS, SELELB, IDELB, VISELB, KIEVOK, MAXSTK, NLOG,
     *  MERR)
C=======================================================================
C $Id: rdeqns.f,v 1.1 2008/10/31 05:04:00 gdsjaar Exp $
...
C         --Process command
     ...
     &        NAMECO, NAMELB, NAMES, TIMES, IPTIMS, IDELB,
