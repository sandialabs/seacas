...
C=======================================================================
     ...
     &           NVARGO, NVARNO, NVAREO, NAMECO, NAMELB,
     &           NAMEGV, NAMENV, NAMEEV, IEVVAR, ISEVOK,
     &           IDELB, NEWID, IEVOK)

C=======================================================================
C $Id: wnam.f,v 1.1 2008/10/31 05:04:01 gdsjaar Exp $
C $Log: wnam.f,v $
...
C
C Revision 1.4  1996/02/12 21:28:52  caforsy
C Removed redundant checks for ExodusII API calls
C
C Revision 1.3  1995/12/10 15:46:56  caforsy
C Integrated call to rpterr and mdcomp/mccomp calls
C
C Revision 1.2  1995/10/26 20:37:49  caforsy
...
C
c Revision 1.1  1995/10/03  21:43:45  mksmith
