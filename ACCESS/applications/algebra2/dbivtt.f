...
C=======================================================================
C$Id: dbivtt.f,v 1.1 2008/10/31 05:04:00 gdsjaar Exp $
C$Log: dbivtt.f,v $
...
C
CRevision 1.3  1996/02/12 21:28:42  caforsy
CRemoved redundant checks for ExodusII API calls
C
CRevision 1.2  1995/12/10 15:46:47  caforsy
CIntegrated call to rpterr and mdcomp/mccomp calls
C
CRevision 1.1  1995/10/03 21:43:32  mksmith
