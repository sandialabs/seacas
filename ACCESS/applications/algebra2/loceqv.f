...
C=======================================================================
C $Id: loceqv.f,v 1.1 2008/10/31 05:04:00 gdsjaar Exp $
C $Log: loceqv.f,v $
...
C
C Revision 1.4  1996/06/11 16:48:15  caforsy
C Removed ifdef CRAY to force program to use dynamic heap.
C Configuration files on cray now force every program to use dynamic
C heap. Fixed reference to nodal variables.  Equations were not being
C evaluated before nodal reference (e.g. 10.5*DISPLX$5).
C
C Revision 1.2  1993/08/02  14:21:13  gdsjaar
C Split out common blocks into separare files. Miscellaneous bug fixes
C on several files.  First public release version.
C
c Revision 1.1  1993/07/30  21:42:53  gdsjaar
c Initial checkin of ACCESS/translate/algII
c
c Revision 1.2  1993/02/18  16:20:47  gdsjaar
c Upped number of equations from 100 to 512.  Changed version number to 2.03
c
c Revision 1.1.1.1  1990/11/09  16:24:50  gdsjaar
c Algebra - Unix Version
c
c Revision 1.1  90/11/09  16:24:48  gdsjaar
c Initial revision
c 
