...
C=======================================================================
C$Id: dbpini.f,v 1.1 2008/10/31 05:04:00 gdsjaar Exp $
C$Log: dbpini.f,v $
...
C
CRevision 1.5  2008/03/14 13:45:26  gdsjaar
CAdded copyright information to top of all files.
C
CALGEBRA2 is now open-sourced under BSD license
C
CRevision 1.4  1997/09/08 15:50:28  gdsjaar
CRemoved some 'confusing parentheses' (in ftncheks opinion)
C
CRevision 1.3  1996/02/12 21:28:43  caforsy
CRemoved redundant checks for ExodusII API calls
C
CRevision 1.2  1995/12/10 15:46:50  caforsy
CIntegrated call to rpterr and mdcomp/mccomp calls
C
CRevision 1.1  1995/10/03 21:43:37  mksmith
