...
C
 ...
 1020   FORMAT(5X,'TIME ',E16.10)
        WRITE(NTPOUT,1030)TMXA(IST),TMXB(IST)
 1030   FORMAT(5X,'X-MOMENTUM,       DONOR ',E12.6,5X,
     &            'RECIPIENT ',E12.6)
        WRITE(NTPOUT,1040)TMYA(IST),TMYB(IST)
 1040   FORMAT(5X,'Y-MOMENTUM,       DONOR ',E12.6,5X,
     &            'RECIPIENT ',E12.6)
        WRITE(NTPOUT,1050)TMZA(IST),TMZB(IST)
 1050   FORMAT(5X,'Z-MOMENTUM,       DONOR ',E12.6,5X,
     &            'RECIPIENT ',E12.6)
        WRITE(NTPOUT,1060)TKEA(IST),TKEB(IST)
 1060   FORMAT(5X,'KINETIC ENERGY,   DONOR ',E12.6,5X,
     &            'RECIPIENT ',E12.6)
        WRITE(NTPOUT,1070)TPSQA(IST),TPSQB(IST)
 1070   FORMAT(5X,'PRESSURE SQUARED, DONOR ',E12.6,5X,
     &            'RECIPIENT ',E12.6)
        WRITE(NTPOUT,1080)TJ2A(IST),TJ2B(IST)
 1080   FORMAT(5X,'J2,               DONOR ',E12.6,5X,
     &            'RECIPIENT ',E12.6)
      END IF
      RETURN
      END
