...
C   $Id: makcol.f,v 1.1 1990/08/20 12:22:00 gdsjaar Exp $
C   $Log: makcol.f,v $
C   Revision 1.1  1990/08/20 12:22:00  gdsjaar
C   Initial revision
C
...
C            --Check column difference
   ...
   50    CONTINUE
d        if (problm) then !#VAX
d           print 150, 'ERROR on column match', !#VAX
d    &         irow, (ielcen(i,irow), i=1,numcol) !#VAX
d        end if !#VAX
d        problm = svprob !#VAX
   60 CONTINUE
...
C            --Chain to the paired row
         ...
         END IF
d        if (problm) then !#VAX
d           print 150, 'ERROR on column align', !#VAX
d    &         irow, (ielcen(i,irow), i=1,numcol) !#VAX
d        end if !#VAX
d        problm = svprob !#VAX
   90 CONTINUE

d     print *, 'Row marks' !#VAX
d     print '(15i5)', (icol1(i), i=1,nerow) !#VAX
...
d     print *, 'Element rows' !#VAX
d     do 140 irow = 1, nerow !#VAX
d        print '(15i5)', (ielcen(i,irow), i=1,numcol) !#VAX
d 140 continue !#VAX

      RETURN
d 150 format (1x, a, 15i5) !#VAX
      END
