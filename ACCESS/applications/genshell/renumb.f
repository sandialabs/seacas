...
C   $Id: renumb.f,v 1.1 1990/08/20 12:22:46 gdsjaar Exp $
C   $Log: renumb.f,v $
C   Revision 1.1  1990/08/20 12:22:46  gdsjaar
C   Initial revision
C
...
d     print 100, (i, ixnp(i), nrnp(i), i=1,numnp) !#VAX
d     print 110, !#VAX
d    &   (i, ixel(i), incel(i), nrel(i), ielcol(i), i=1,numel) !#VAX
   90 CONTINUE
      RETURN
d 100 format (/, ' NODES (index, new_index, #_generated)', !#VAX
d    &   /, 6 (i5, i5, i3)) !#VAX
d 110 format (/, ' ELEMENTS', !#VAX
d    &   ' (index, new_index, increment, #_generated, #_column)', !#VAX
d    &   /, 4 (i6, i5, i4, i3, i2)) !#VAX
      END
