...
C   $Id: newel1.f,v 1.2 1991/01/09 12:59:22 gdsjaar Exp $
C   $Log: newel1.f,v $
C   Revision 1.2  1991/01/09 12:59:22  gdsjaar
C   Initial conversion from GEN3D to GENSHELL, no BC yet
C
c Revision 1.1.1.1  90/08/20  12:22:13  gdsjaar
c Gen3D Mesh Generation Program
c 
c Revision 1.1  90/08/20  12:22:12  gdsjaar
c Initial revision
c 
...
C   --   NUMLNK - IN - the number of nodes in the element
...
C   --   LINK - IN - the 2D connectivity array (always 4 nodes) for the block
...
C   --
C   --Database must be positioned at start of block's coordinates
C   --upon entry; upon exit at end of block's attributes.
