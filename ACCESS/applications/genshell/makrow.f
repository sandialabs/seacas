...
C   $Id: makrow.f,v 1.1 1990/08/20 12:22:05 gdsjaar Exp $
C   $Log: makrow.f,v $
C   Revision 1.1  1990/08/20 12:22:05  gdsjaar
C   Initial revision
C
...
d        iel = ielrow(icol1) !#VAX
d        l1 = LINK(ix1,iel) !#VAX
d        l4 = LINK(ix4,iel) !#VAX
d        do 30 ichk = ifill, numcen !#VAX
d           ic = ielrow(ichk) !#VAX
d           if ((l1 .eq. LINK(ix2,ic)) .and. (l4 .eq. LINK(ix3,ic))) !#VAX
d    &         print *, 'ERROR on leftmost check' !#VAX
d  30    continue !#VAX
...
C      --Find elements to the right of the element until at rightmost column
   ...
   40    CONTINUE
     ...
     &         .AND. (L3 .EQ. LINK(IX4,IC))) THEN
            ...
            END IF
   50    CONTINUE
d        print 60, nerow, (ielrow(i), i=icol1,icol1+ncol-1) !#VAX
      ...
      RETURN
d  60 format (' Elements', 3x, 'Row', i3, 3x, 10i4) !#VAX
      END
