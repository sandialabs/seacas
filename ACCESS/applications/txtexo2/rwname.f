...
C $Id: rwname.f,v 1.1 2008/10/31 05:04:17 gdsjaar Exp $
C=======================================================================
...
C ... Allocate array for names
      ...
      call mcrsrv('NAMES', kname, mxstln*maxvar)
      call mcstat(nerr, mem)
      if (nerr .gt. 0) then
        return 1
      end if
      
      call rwnam1(ntxt, ndb, 'G', nvargl, c(kname), *180)
      call rwnam1(ntxt, ndb, 'N', nvarnp, c(kname), *180)
      call rwnam1(ntxt, ndb, 'E', nvarel, c(kname), *180)
...
C ... Temporary logical array
  ...
  180 CONTINUE
      ...
      subroutine rwnam1(ntxt, ndb, flag, nvar, names, *)
      include 'exodusII.inc'
      character*1 flag
