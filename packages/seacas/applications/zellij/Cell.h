...
public:
  ...
  void populate_neighbor_min_i(const std::vector<INT> &map, const Cell &neighbor) const;
  template <typename INT>
  void populate_neighbor_min_j(const std::vector<INT> &map, const Cell &neighbor) const;
  template <typename INT>
  void populate_neighbor_br(const std::vector<INT> &map, const Cell &neighbor) const;
  template <typename INT>
  void populate_neighbor_bl(const std::vector<INT> &map, const Cell &neighbor) const;
