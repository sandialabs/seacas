...
class MeshFixture : public ::testing::Test {
 protected:
  MeshFixture()
  : m_communicator(Ioss::ParallelUtils::comm_world()), m_spatialDim(3)
  {
    setup_empty_mesh();
  }
  ...
  {
    ThrowRequireWithMsg(m_iossMesh!=nullptr, "Unit test error. Trying to get mesh before it has been initialized.");
    return *m_iossMesh;
  }
