...
C    
C $Id: ewqain.f,v 1.3 2008/03/14 13:50:49 gdsjaar Exp $
C=======================================================================
      SUBROUTINE EWQAIN (NDB, QAINFO, NQAREC, QAREC, NINFO, INFO)
C=======================================================================
C
C   --*** EWQAIN *** Exodus Write QA and INformation records
...
C   --   QAINFO - IN - the QA record for the current run
