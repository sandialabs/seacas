...
C    
C $Id: erqain.f,v 1.3 2008/03/14 13:50:48 gdsjaar Exp $
C=======================================================================
      SUBROUTINE ERQAIN (NDB, OPTION, NQAREC, QAREC, NINFO, INFO)
C=======================================================================
C   --*** ERQAIN *** Exodus Read QA and INformation records
