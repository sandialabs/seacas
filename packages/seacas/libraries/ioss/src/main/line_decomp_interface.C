...
Line_Decomp::Interface::Interface() { enroll_options(); }

Line_Decomp::Interface::~Interface() = default;

void Line_Decomp::Interface::enroll_options()
{
...
bool Line_Decomp::Interface::parse_options(int argc, char **argv)
{
  // Get options from environment variable also...
  char *options = getenv("IO_LINE_DECOMP_OPTIONS");
  if (options != nullptr) {
    fmt::print(stderr,
               "\nThe following options were specified via the IO_LINE_DECOMP_OPTIONS environment "
               "variable:\n"
               "\t{}\n\n",
               options);
  ...
  if (options_.retrieve("help") != nullptr) {
    ...
    fmt::print(stderr,
               "\n\tCan also set options via IO_LINE_DECOMP_OPTIONS environment variable.\n\n"
