...
/* Non-blocking (PnetCDF) output -- see src/ex_nonblocking.c */
EXODUS_EXPORT int  exi_nb_set_enabled(int exoid, int enable);
EXODUS_EXPORT int  exi_nb_enabled(int exoid);
EXODUS_EXPORT int  exi_nb_put_vara(int exoid, int varid, const size_t *start, const size_t *count,
                                   int is_float, const void *data);
